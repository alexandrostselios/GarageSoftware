...
namespace GarageAPI.Migrations
{
    ...
    [Migration("20240417082545_EngineerSpecialities")]
    partial class EngineerSpecialities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            {
                b.Property<long>("ID")
                    .ValueGeneratedOnAdd() // Database-generated identity column
                    .HasColumnType("bigint");

                //SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ID")); // Indicate identity column
                ...
                b.HasKey("EngineerID", "SpecialityID"); // Set composite primary key
            ...
            modelBuilder.Entity("GarageAPI.Models.User.Customer", b =>
                {
                    b.Property<long>("CustomerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GarageAPI.Models.User.Engineer", b =>
                {
                    b.Property<long>("EngineerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GarageAPI.Models.CustomerCars.CustomerCar", b =>
                {
                    b.HasOne("GarageAPI.Models.User.Customer", "Customer")
                        .WithMany()
