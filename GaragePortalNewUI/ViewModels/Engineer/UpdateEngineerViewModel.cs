...
{
    public class UpdateEngineerViewModel
    {
        private readonly ResourceManager _resourceManager;

        public UpdateEngineerViewModel(ResourceManager resourceManager)
        {
            _resourceManager = resourceManager;
        }

        public UpdateEngineerViewModel()
        {
       ...
       // public List<EngineerSpeciality>? EngineerSpeciality { get; set; }
    }
}